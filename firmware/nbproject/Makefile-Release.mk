...
${OBJECTDIR}/App/alarms.o: App/alarms.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/App/alarms.o App/alarms.c
...
${OBJECTDIR}/App/status_bar/status_bar.o: App/status_bar/status_bar.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/App/status_bar/status_bar.o App/status_bar/status_bar.c
...
${OBJECTDIR}/kernel/drivers/beep_simulator.o: kernel/drivers/beep_simulator.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/kernel/drivers/beep_simulator.o kernel/drivers/beep_simulator.c

${OBJECTDIR}/kernel/drivers/cpu_control.o: kernel/drivers/cpu_control.c
	${MKDIR} -p ${OBJECTDIR}/kernel/drivers
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/kernel/drivers/cpu_control.o kernel/drivers/cpu_control.c

${OBJECTDIR}/kernel/drivers/keyboard.o: kernel/drivers/keyboard.c
	${MKDIR} -p ${OBJECTDIR}/kernel/drivers
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/kernel/drivers/keyboard.o kernel/drivers/keyboard.c

${OBJECTDIR}/kernel/drivers/lcd_simulator.o: kernel/drivers/lcd_simulator.c
	${MKDIR} -p ${OBJECTDIR}/kernel/drivers
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/kernel/drivers/lcd_simulator.o kernel/drivers/lcd_simulator.c

${OBJECTDIR}/kernel/drivers/real_time_clock.o: kernel/drivers/real_time_clock.c
	${MKDIR} -p ${OBJECTDIR}/kernel/drivers
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/kernel/drivers/real_time_clock.o kernel/drivers/real_time_clock.c

${OBJECTDIR}/kernel/fonts/alfanum_6.o: kernel/fonts/alfanum_6.c
	${MKDIR} -p ${OBJECTDIR}/kernel/fonts
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/kernel/fonts/alfanum_6.o kernel/fonts/alfanum_6.c

${OBJECTDIR}/kernel/fonts/alfanum_8.o: kernel/fonts/alfanum_8.c
	${MKDIR} -p ${OBJECTDIR}/kernel/fonts
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/kernel/fonts/alfanum_8.o kernel/fonts/alfanum_8.c

${OBJECTDIR}/kernel/fonts/numeric_16.o: kernel/fonts/numeric_16.c
	${MKDIR} -p ${OBJECTDIR}/kernel/fonts
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/kernel/fonts/numeric_16.o kernel/fonts/numeric_16.c

${OBJECTDIR}/kernel/fonts/numeric_24.o: kernel/fonts/numeric_24.c
	${MKDIR} -p ${OBJECTDIR}/kernel/fonts
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/kernel/fonts/numeric_24.o kernel/fonts/numeric_24.c

${OBJECTDIR}/kernel/kernel.o: kernel/kernel.c
	${MKDIR} -p ${OBJECTDIR}/kernel
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/kernel/kernel.o kernel/kernel.c

${OBJECTDIR}/kernel/screen/debug.o: kernel/screen/debug.c
	${MKDIR} -p ${OBJECTDIR}/kernel/screen
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/kernel/screen/debug.o kernel/screen/debug.c

${OBJECTDIR}/kernel/screen/notepad.o: kernel/screen/notepad.c
	${MKDIR} -p ${OBJECTDIR}/kernel/screen
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/kernel/screen/notepad.o kernel/screen/notepad.c

${OBJECTDIR}/kernel/screen/screen.o: kernel/screen/screen.c
	${MKDIR} -p ${OBJECTDIR}/kernel/screen
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/kernel/screen/screen.o kernel/screen/screen.c

${OBJECTDIR}/kernel/settings/keyboard.o: kernel/settings/keyboard.c
	${MKDIR} -p ${OBJECTDIR}/kernel/settings
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/kernel/settings/keyboard.o kernel/settings/keyboard.c

${OBJECTDIR}/kernel/settings/screens.o: kernel/settings/screens.c
	${MKDIR} -p ${OBJECTDIR}/kernel/settings
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/kernel/settings/screens.o kernel/settings/screens.c

${OBJECTDIR}/kernel/settings/std.o: kernel/settings/std.c
	${MKDIR} -p ${OBJECTDIR}/kernel/settings
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/kernel/settings/std.o kernel/settings/std.c

${OBJECTDIR}/kernel/settings/upp.o: kernel/settings/upp.c
	${MKDIR} -p ${OBJECTDIR}/kernel/settings
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/kernel/settings/upp.o kernel/settings/upp.c

${OBJECTDIR}/kernel/settings/util.o: kernel/settings/util.c
	${MKDIR} -p ${OBJECTDIR}/kernel/settings
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/kernel/settings/util.o kernel/settings/util.c

${OBJECTDIR}/kernel/std.o: kernel/std.c
	${MKDIR} -p ${OBJECTDIR}/kernel
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/kernel/std.o kernel/std.c

${OBJECTDIR}/kernel/upp/upp.o: kernel/upp/upp.c
	${MKDIR} -p ${OBJECTDIR}/kernel/upp
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/kernel/upp/upp.o kernel/upp/upp.c
...
${OBJECTDIR}/screens/alarms.o: screens/alarms.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/screens/alarms.o screens/alarms.c

${OBJECTDIR}/screens/alarms_ringing.o: screens/alarms_ringing.c
	${MKDIR} -p ${OBJECTDIR}/screens
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/screens/alarms_ringing.o screens/alarms_ringing.c

${OBJECTDIR}/screens/alarms_settings.o: screens/alarms_settings.c
	${MKDIR} -p ${OBJECTDIR}/screens
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/screens/alarms_settings.o screens/alarms_settings.c

${OBJECTDIR}/screens/calendar.o: screens/calendar.c
	${MKDIR} -p ${OBJECTDIR}/screens
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/screens/calendar.o screens/calendar.c

${OBJECTDIR}/screens/calendar_events.o: screens/calendar_events.c
	${MKDIR} -p ${OBJECTDIR}/screens
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/screens/calendar_events.o screens/calendar_events.c
...
${OBJECTDIR}/screens/menu.o: screens/menu.c
	${MKDIR} -p ${OBJECTDIR}/screens
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/screens/menu.o screens/menu.c

${OBJECTDIR}/screens/settings.o: screens/settings.c
	${MKDIR} -p ${OBJECTDIR}/screens
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/screens/settings.o screens/settings.c

${OBJECTDIR}/screens/settings_date_hour.o: screens/settings_date_hour.c
	${MKDIR} -p ${OBJECTDIR}/screens
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/screens/settings_date_hour.o screens/settings_date_hour.c
...
${OBJECTDIR}/screens/stopwatch.o: screens/stopwatch.c
	${MKDIR} -p ${OBJECTDIR}/screens
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/screens/stopwatch.o screens/stopwatch.c
